...
public class CabTypeAdapter extends RecyclerView.Adapter<CabTypeAdapter.ViewHolder> {
    ...
    public void setData(CabTypeAdapter.ViewHolder viewHolder, final int position, boolean isHoverOLD) {
        ...
        String eShowCabTime = item.get("eShowCabTime");
        if(eShowCabTime != null && !eShowCabTime.equals("") && eShowCabTime.equalsIgnoreCase("Yes")){
            viewHolder.availabelCabsEtaArea.setVisibility(View.VISIBLE);
            String timeTxt = item.get("timeTxt");
            if (timeTxt != null && !timeTxt.equalsIgnoreCase("")) {
                viewHolder.timeTxt.setText(item.get("timeTxt"));
            }else{
                viewHolder.timeTxt.setText("--");
            }
        }else {
            viewHolder.availabelCabsEtaArea.setVisibility(View.GONE);
        }
...
//
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        LinearLayout availabelCabsEtaArea;
        MTextView timeTxt;
        ...
        public ViewHolder(View view) {
            ...
            availabelCabsEtaArea = (LinearLayout) view.findViewById(R.id.availabelCabsEtaArea);
