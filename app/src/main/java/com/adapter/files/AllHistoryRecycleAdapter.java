...
*/
            ...
            if (Utils.checkText(iActive)) {
                ...
                if (iActive.equalsIgnoreCase("Canceled") || iActive.equalsIgnoreCase("Finished")){
                    viewHolder.statusVTxt.setText(iActive);
                } else {
                    if (item.get("iActiveDisplay").equals("Yes")){
                        viewHolder.statusVTxt.setText(item.get("vTripStatus"));
                    } else {
                        viewHolder.statusVTxt.setText(item.get("iActiveDisplay"));
                    }
                }
