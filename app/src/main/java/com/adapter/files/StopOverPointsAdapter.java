...
public class StopOverPointsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public StopOverPointsAdapter(Context mContext, ArrayList<Stop_Over_Points_Data> list, GeneralFunctions generalFunc, boolean isFooterEnabled, RecyclerView stopOverPointsSubRecyclerView, boolean isFromHome) {
        ...
        //LBL_STOP_OVER_TXT = generalFunc.retrieveLangLBl("Where To?", "LBL_WHERE_TO");
        LBL_DROP_AT = generalFunc.retrieveLangLBl("Where To?", "LBL_WHERE_TO");
    ...
    public StopOverPointsAdapter(Context mContext, ArrayList<Stop_Over_Points_Data> list, GeneralFunctions generalFunc, boolean isFooterEnabled, boolean addTextChangeListner, RecyclerView stopOverPointsSubRecyclerView, boolean isFromHome) {
        this.mContext = mContext;
        this.list = list;
        this.generalFunc = generalFunc;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        if (position == 0 && list.size() < 3){
            viewHolder.editArea.setVisibility(View.VISIBLE);
        }else{
            viewHolder.editArea.setVisibility(View.GONE);
        }

        if (position == pos && selecetdViewList[pos]) {
           /* if (isFromHome && position == 0) {
                //viewHolder.stopOverPoint.setSelection(Objects.requireNonNull(viewHolder.stopOverPoint.getText()).length());
        ...
        viewHolder.iv_editStopPoint.setTag(position);
        viewHolder.removeArea.setTag(position);
        viewHolder.editArea.setTag(position);
        ...
        viewHolder.iv_addStopPoint.setVisibility(View.GONE);
        ...
        if (addTextChangeListner) {
            ...
            viewHolder.cancelArea.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    //if (pos == 0 && isFirstTime) isFirstTime = false;
                    return true;
                }
            });
...
//        });
        ...
        /*if (*//*position == 0 && *//*viewHolder.editArea.getVisibility() == View.GONE){*/
        ...
        /*}*/
        viewHolder.editArea.setOnClickListener(v -> {
            if (addTextChangeListner) ((SearchLocationActivity) mContext).selectedPos = position;
            else ((SearchLocationActivity) mContext).subSelectedPos = position;
            isTouch = true;
            setBounceAnimation(viewHolder.stopOverPoint, () -> {
                if (onStopOverClickListener != null) {
                    onStopOverClickListener.onStopOverClickList(viewHolder.stopOverPoint, "", position);
        ...
        /*if (position == 0 && isFromHome) {
            *//*viewHolder.stopOverPoint.requestFocus();
            ((SearchLocationActivity) mContext).selectedPos = position;
            isTouch = true;
            setBounceAnimation(viewHolder.stopOverPoint, () -> {
                if (onStopOverClickListener != null) {
...
//            int right =!isRtlMode ? 0 : padding1;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private ImageView iv_round_img, iv_loc_img, imageCancel, iv_addStopPoint, iv_removeStopPoint, iv_editStopPoint;
        ...
        private LinearLayout removeArea,editArea;
        ...
        public ViewHolder(View view) {
            ...
            iv_editStopPoint = (ImageView) view.findViewById(R.id.iv_editStopPoint);
            ...
            editArea = (LinearLayout) view.findViewById(R.id.editArea);
        }
    }
