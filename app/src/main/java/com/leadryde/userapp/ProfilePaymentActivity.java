...
public class ProfilePaymentActivity extends AppCompatActivity {
    ...
    private void manageWalletView() {
        if (!generalFunc.getJsonValue(Utils.WALLET_ENABLE, userProfileJson).equals("") &&
                generalFunc.getJsonValue(Utils.WALLET_ENABLE, userProfileJson).equalsIgnoreCase("Yes") && generalFunc.getJsonValue("ENABLE_WALLET_USER_SIDE", userProfileJson).equalsIgnoreCase("Yes")) {
...
//        cashTxt.setText(generalFunc.retrieveLangLBl("", "LBL_CASH_TXT"));
        cashTxt.setText(generalFunc.retrieveLangLBl("", "LBL_CASH_OR_CARD"));
