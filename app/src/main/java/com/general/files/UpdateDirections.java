...
public class UpdateDirections implements UpdateFrequentTask.OnTaskRunCalled, MapDelegate {
    ...
    public UpdateDirections(Context mcontext, GoogleMap googleMap, Location userLocation, Location destinationLocation) {
        ...
        DRIVER_ARRIVED_MIN_TIME_PER_MINUTE = generalFunctions.parseFloatValue(3, generalFunctions.getJsonValue("DRIVER_ARRIVED_MIN_TIME_PER_MINUTE", userProfileJson));
    }
    ...
    public void scheduleDirectionUpdate() {
        ...
        updateFreqTask = new UpdateFrequentTask((int) (generalFunctions.parseDoubleValue(2, DESTINATION_UPDATE_TIME_INTERVAL) * 5 * 1000));
