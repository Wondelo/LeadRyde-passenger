...
import com.leadryde.userapp.SupportActivity;
import com.leadryde.userapp.UberXActivity;
...
//        isMenuState = true;
    ...
    public void Managemenu() {
        if (generalFunc.getMemberId().equalsIgnoreCase("")) {
            ...
            obj_userProfile = generalFunc.getJsonObject(userProfileJson);
            if(generalFunc.getJsonValue("ENABLE_WALLET_USER_SIDE", userProfileJson).equalsIgnoreCase("Yes")) {
