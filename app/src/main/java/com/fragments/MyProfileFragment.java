...
import com.leadryde.userapp.BusinessProfileActivity;
import com.leadryde.userapp.CardPaymentActivity;
import com.leadryde.userapp.ContactUsActivity;
import com.leadryde.userapp.DonationActivity;
import com.leadryde.userapp.EmergencyContactActivity;
import com.leadryde.userapp.FavouriteDriverActivity;
import com.leadryde.userapp.HelpActivity;
import com.leadryde.userapp.InviteFriendsActivity;
import com.leadryde.userapp.MenuSettingActivity;
import com.leadryde.userapp.MyProfileActivity;
import com.leadryde.userapp.MyWalletActivity;
import com.leadryde.userapp.NotificationActivity;
import com.leadryde.userapp.R;
import com.leadryde.userapp.SearchPickupLocationActivity;
import com.leadryde.userapp.StaticPageActivity;
import com.leadryde.userapp.VerifyInfoActivity;
...
public class MyProfileFragment extends Fragment {
    ...
    private String DIRECT_CHAT_LINK;
...
//        }
    ...
    public void manageView() {
        if (generalFunc.getJsonValue("ENABLE_LIVE_CHAT", userProfileJson).equalsIgnoreCase("Yes") ||
                generalFunc.getJsonValue("ENABLE_DIRECT_CHAT", userProfileJson).equalsIgnoreCase("Yes")) {
...
//        if (generalFunc.getJsonValueStr(Utils.DONATION_ENABLE, obj_userProfile).equalsIgnoreCase("Yes")/* && !APP_TYPE.equals(Utils.CabGeneralTypeRide_Delivery_UberX)*/) {
        ...
        if (!generalFunc.getJsonValueStr(Utils.WALLET_ENABLE, obj_userProfile).equals("") &&
                generalFunc.getJsonValueStr(Utils.WALLET_ENABLE, obj_userProfile).equalsIgnoreCase("Yes")&&generalFunc.getJsonValue("ENABLE_WALLET_USER_SIDE", userProfileJson).equalsIgnoreCase("Yes")) {
    ...
    public void setuserInfo() {
        ...
        boolean isOnlyCashEnabled = generalFunc.getJsonValue("APP_PAYMENT_MODE", userProfileJson).equalsIgnoreCase("Cash") || generalFunc.getJsonValue("ENABLE_WALLET_USER_SIDE", userProfileJson).equalsIgnoreCase("No");
            ...
            switch (view.getId()) {
                ...
                case R.id.liveChatArea:
                    if (generalFunc.getJsonValue("ENABLE_LIVE_CHAT", userProfileJson).equalsIgnoreCase("Yes")) {
                        ...
                        DIRECT_CHAT_LINK = generalFunc.getJsonValue("DIRECT_CHAT_LINK", userProfileJson);
                        new StartActProcess(getActContext()).openURL(DIRECT_CHAT_LINK);
                    }
                    break;
